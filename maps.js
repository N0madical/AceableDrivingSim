...
guipages = [
    ...
    exportHud = [
        ...
        new hudRect(50, 95, 20, 5, "#1b2932", 10, false, "both", 1, "closePort", ["0"]),
        new hudText("Close", 50, 95, 30, "center"),
    ],
    importHud = [
        new hudRect(50, 50, 100, 100, "black", 0, false, "both", 0.6),
        new hudText("Import Map", 50, 5, 50, "center"),
        new hudRect(37, 95, 20, 5, "#1b2932", 10, false, "both", 1, "closePort", ["0"]),
        new hudRect(63, 95, 20, 5, "#1b2932", 10, false, "both", 1, "closePort", ["1"]),
        new hudText("Close", 37, 95, 30, "center"),
        new hudText("Load", 63, 95, 30, "center"),
        new hudText("", 50, 8, 15, "center"),
    ],
    settingsmenutext = [
